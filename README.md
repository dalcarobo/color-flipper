...
Estes são os arquivos iniciais do projeto **Color Flipper**.
...
```sh
  $ git clone https://github.com/dalcarobo/color-flipper.git
```
...
```sh
  $ cd color-flipper # para acessar a pasta clonada do git
